...
create table tb_product (id int8 generated by default as identity, description varchar(255), image_uri varchar(355), name varchar(255), price float8, primary key (id));
